...
/*   Updated: 2025/09/29 22:14:18 by yocto            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_window(t_game *game)
{
	...
	game->win_ptr = mlx_new_window(game->mlx_ptr, game->x * TILE_SIZE, game->y
			* TILE_SIZE, "so_long");
...
{
	game->img_wall = mlx_xpm_file_to_image(game->mlx_ptr, "images/wall.xpm",
			&game->img_w, &game->img_h);
	game->img_floor = mlx_xpm_file_to_image(game->mlx_ptr, "images/floor.xpm",
			&game->img_w, &game->img_h);
	game->img_player_normal = mlx_xpm_file_to_image(game->mlx_ptr,
			"images/player.xpm", &game->img_w, &game->img_h);
	game->img_player_on_exit = mlx_xpm_file_to_image(game->mlx_ptr,
			"images/P+E.xpm", &game->img_w, &game->img_h);
	game->img_player = game->img_player_normal;
	game->img_exit = mlx_xpm_file_to_image(game->mlx_ptr, "images/exit.xpm",
			&game->img_w, &game->img_h);
	game->img_collect = mlx_xpm_file_to_image(game->mlx_ptr,
			"images/collect.xpm", &game->img_w, &game->img_h);
	game->img_enemy = mlx_xpm_file_to_image(game->mlx_ptr, "images/enemy.xpm",
			&game->img_w, &game->img_h);
